...
//	 également que sélectionner les livres concernés
	@Query("SELECT DISTINCT u FROM UserEntity u INNER JOIN FETCH u.loanList l WHERE l.endOfLoaningDate < ?1")
	List<UserEntity> findUsersByOverdueLoans (LocalDateTime currentDateTime);
